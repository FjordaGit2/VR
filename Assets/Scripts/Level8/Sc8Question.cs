...
public class Sc8Question : MonoBehaviour
{
    ...
    IEnumerator PostData()
    {
        ...
        try
        {
            string dir = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/Sc8Questionnaire/{LevelScript.UserName}";
        ...
        {
            Debug.LogError($"Sc8Question local save failed: {e.Message}");
