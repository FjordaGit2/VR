...
public class Sc6Question : MonoBehaviour
{
    ...
    IEnumerator PostData()
    {
        ...
        try
        {
            string dir = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/Sc6Questionnaire/{LevelScript.UserName}";
        ...
        {
            Debug.LogError($"Sc6Question local save failed: {e.Message}");
