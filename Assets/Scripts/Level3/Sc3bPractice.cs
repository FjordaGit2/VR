...
public class Sc3bPractice : MonoBehaviour
{
    ...
    void BuildPracticeRoadList()
    {
        ...
        var built = StudyTrialSequence.BuildPracticeSequences(
            TotalCount, prefabCount, StudyTrialSequence.SeedSaltSc3bPractice);
    ...
    IEnumerator StartAgain()
    {
        ...
        if (CanvasText != null)
            CanvasText.text = "Please start again. Make sure you press the opposite correct direction in the rounded button of the controller depending where the target car is shown, and ignore the police car if it appears on the other road.";
        if (buttonStartPractice != null)
