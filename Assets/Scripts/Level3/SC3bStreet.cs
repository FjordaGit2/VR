...
public class SC3bStreet : LevelScript
{
    ...
    void Awake()
    {
        ...
        recorder.customPath = $"{Application.dataPath}/Data/{UserGroup}/Sc5Street/{UserName}/Behavioural";
    ...
    IEnumerator Post(bool IsLeft)
    {
        ...
        string dir = recorder != null ? recorder.customPath : $"{Application.dataPath}/Data/{UserGroup}/Sc5Street/{UserName}/Behavioural";
        ...
        string accuracy = (SpawnPosIndex == 0 == IsLeft) ? "Wrong" : "Correct";
