...
public class Sc2bQuestion : MonoBehaviour
{
    ...
    IEnumerator SaveAnswersLocally()
    {
        ...
        try
        {
            StudyQuestionnaireSave.SaveAnswers(LevelScript.QuestionnaireFileSc2b, new[] { _q1, _q2, _q3, _q4, _q5, _q6 });
            Debug.Log($"Sc2bQuestion: saved to {LevelScript.GetQuestionnaireDirectory()}/{LevelScript.QuestionnaireFileSc2b}");
