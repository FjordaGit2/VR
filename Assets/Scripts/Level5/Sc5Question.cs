...
public class Sc5Question : MonoBehaviour
{
    ...
    IEnumerator PostData()
    {
        ...
        try
        {
            string dir = $"{Application.dataPath}/Data/{LevelScript.UserGroup}/Sc5Questionnaire/{LevelScript.UserName}";
        ...
        {
            Debug.LogError($"Sc5Question local save failed: {e.Message}");
